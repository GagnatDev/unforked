...
export async function resetDb(): Promise<void> {
  await sql`TRUNCATE recipes, meal_plans, shopping_lists, ingredient_categories, users, families, family_invitations, auth_migration RESTART IDENTITY CASCADE`.execute(
    testDb(),
  );
}
